                ...
                <div class="col-auto d-flex align-items-center my-2 my-sm-0">
                    <div class="pb-3">
                        <ul class="nav nav-tabs nav-tabs-md nav-tabs-line position-relative zIndex-0">
                                ...
                                <li class="nav-item">
                                    <router-link to="/users/create" class="nav-link"><i class="fal fa-eye"></i>New Users</router-link>
                                </li>
                            <!-- <li class="nav-item">
            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card rounded-12 shadow-dark-80 border border-gray-50 mb-3 mb-xl-5">
                    <div class="d-flex align-items-center px-3 px-md-4 py-3 border-bottom border-gray-200">
                        <h5 class="card-header-title my-2 ps-md-3 font-weight-semibold">Edit New User</h5>
                    </div>
                        ...
                        <form class="px-3 form-style-two" id="form"
                                ...
                                <div class="mb-4 mb-xl-5">
                                    ...
                                    <label class="form-label form-label-lg mb-3 mb-md-4">Photo (Optional)</label>
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-circle" v-if="user.image" v-show="existimage">
                                            <img class="avatar-img" v-bind:src="'/storage/images/users/'+ user.image" alt="User">
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-md-4 pb-3">
                                    <label for="FullName" class="form-label form-label-lg">User Name</label>
                                ...
                                <div class="col-sm-6 mb-md-4 pb-3">
                                    ...
                                    <input type="text" class="form-control form-control-xl" id="emplaName" placeholder="Enter last name" v-model="user.lastname" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-md-4 pb-3">
                                    ...
                                    <input type="password" class="form-control form-control-xl" id="empPassword" placeholder="Enter password"  v-model="user.password">
                                </div>

                                <div class="col-sm-6 mb-md-4 pb-3">
                                    <label for="empCPassword" class="form-label form-label-lg">Confirm Password</label>
                                    <input type="password" class="form-control form-control-xl" id="empCPassword" placeholder="Confirm password" v-model="user.password_confirmation">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-md-4 pb-3">
                                    <label for="empaddress" class="form-label form-label-lg">Role</label>
...
import { required,email, minLength } from "vuelidate/lib/validators";
    ...
    methods: {
            onFileChange(event){
                ...
                this.user.new_image = event.target.files[0];
                let reader  = new FileReader();
                reader.addEventListener("load", function () {
                    this.showPreview = true;
                    this.imagePreview = reader.result;
                }.bind(this), false);
                if( this.user.new_image ){
                    if ( /\.(jpe?g|png|gif)$/i.test( this.user.new_image.name ) ) {
                        reader.readAsDataURL( this.user.new_image );
                    }
                }
            },
         EditUser(){
