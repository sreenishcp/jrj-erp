                ...
                <div class="col-auto d-flex align-items-center my-2 my-sm-0">
                    <div class="pb-3">
                        <ul class="nav nav-tabs nav-tabs-md nav-tabs-line position-relative zIndex-0">
                            <li class="nav-item">
                                <router-link to="/users" class="nav-link active"><i class="fal fa-eye"></i> All Users</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/users/create" class="nav-link"><i class="fal fa-plus"></i> Add users</router-link>
                            </li>
                            <!-- <li class="nav-item">
            ...
            <div class="col-xl-12 col-xxl-12">
                ...
                <div class="card rounded-12 shadow-dark-80 border border-gray-50">
                    <div class="d-flex align-items-center px-3 px-md-4 py-3">
                        <h5 class="card-header-title mb-0 ps-md-2 font-weight-semibold">All Users</h5>
                        ...
                        <table class="table card-table table-nowrap overflow-hidden">
                            ...
                            <tbody class="list">
                                <tr v-for="user in users" :key="user.id">
                                    <td><span class="avatar avatar-circle" v-if="user.image">
                                        <img class="avatar-img" v-bind:src="'/storage/images/users/'+ user.image" alt="Employee">
                                        </span>
                                        <span class="avatar avatar-circle" v-else>
                                        <img class="avatar-img" src="assets/img/avatar1.png" alt="Employee">
                                        </span>
                                    </td>
                                    <td><span class="font-weight-semibold text-gray-700">{{user.firstname}} {{user.last_name != '' ? user.last_name:''}}</span></td>
                                    <td><span class="text-gray-700">{{user.email}}</span></td>
                                    <td><span class="text-gray-700">{{user.phone}}</span></td>
                                    <td><span class="text-gray-700">{{user.role.charAt(0).toUpperCase()+ user.role.substr(1)}}</span></td>
                                    <td><span class="badge bg-green-200 p-2">{{user.status == 0 ? 'Active' : 'InActive'}}</span></td>
                                    <td>
                                        <div class="dropdown ">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                </router-link>                                         <a href="#!" class="dropdown-item" @click.prevent="deleteUser(user.id)">
