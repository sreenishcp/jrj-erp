                ...
                <div class="col-xl-12 col-xxl-12">
                    ...
                    <div class="card rounded-12 shadow-dark-80 border border-gray-50">
                        <div class="d-flex align-items-center px-3 px-md-4 py-3">
                            <h5 class="card-header-title mb-0 ps-md-2 font-weight-semibold">All Employees</h5>
                            ...
                            <table class="table card-table table-nowrap overflow-hidden">
                                ...
                                <tbody class="list">
                                    <tr v-for="employee in employees" :key="employee.id">
                                        <td><span class="avatar avatar-circle" v-if="employee.image">
                                            <img class="avatar-img" v-bind:src="'/storage/images/employees/'+ employee.image" alt="Employee">
                                            </span>
                                            <span class="avatar avatar-circle" v-else>
                                            <img class="avatar-img" src="assets/img/avatar1.png" alt="Employee">
                                            </span>
                                        </td>
                                        <td><span class="font-weight-semibold text-gray-700">{{ employee.name }}</span></td>
                                        
                                        <td><span>{{ (employee.designation.charAt(0).toUpperCase()+ employee.designation.substr(1)).replace("_"," ") }}</span></td>
                                        <td><span class="text-gray-700">{{employee.email}}</span></td>
                                        <td><span class="text-gray-700">{{employee.phone}}</span></td>
                                        <td><span class="badge bg-green-200 p-2"> {{employee.status == 0 ? 'Active' : 'InActive'}}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <router-link :to="{name: 'employees.edit', params: { id: employee.id }}" class="dropdown-item">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </router-link>                                         <a href="#!" class="dropdown-item" @click.prevent="deleteEmploy(employee.id)">
    ...
    methods: {
      deleteEmploy(id)
      {
        if(confirm("Do you really want to delete?")){
            let uri = `/api/employees/delete/${id}`;
